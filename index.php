...
<span class="login100-form-title p-b-34 p-t-27">
    Welcome to Jama Reporting Portal <br>
    <a style="color: white; font-size: 16px; text-decoration:none; padding-right: 20px;" href="staff/login.php">Staff Login </a> 
    <a style="color: white; font-size: 16px; text-decoration: none;" href="">Admin Login </a> 
</span>	
