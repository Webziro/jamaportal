...
<html lang="en">
    <head>
        ...
        <link href="../student-dashboard/index.css" rel="stylesheet" />
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered">
                                   <tr>
                                    <th>First Name</th>
                                       <td colspan="3"><?php echo $data['fname']; ?></td>
                                   </tr>
                                   <tr>
                                       <th>Last Name</th>
                                       <td colspan="3"><?php echo $data['lname'];?> </td>
                                   </tr>
                                   <tr>
                                       <th>Email</th>
                                     ...
                                     <tr>
                                       ...
                                       <td colspan="3"><?php echo $data['contact'];?></td>
                                        ...
                                        <tr>
                                       <th>Reg. Date</th>
                                       <td colspan="3"><?php echo $data['posting_date'];?></td>
                                   </tr>
                                    </tbody>
                                </table>
                            </div>
